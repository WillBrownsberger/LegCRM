...
/*
* 
* class-wic-control-integer.php
*
* validates and emits integer  update values
*/

class WIC_Control_Integer extends WIC_Control_Parent {
    ...
    public function validate()  { 
        ...
        if($temp_val > '' && $temp_val != strval($this->value)) {
            return "{$this->field_label} must be a number with no decimal point.";
        } else {
            return '';
        }
    }
    ...
    // in case an entity specific validator overrides $this->validate, assure that only save integer
