...
11. Use the files in /LegCRMtoGraph to populate a repo in your Azure Devops and configure appSettings.json in each of the four subdirectories to reflect your Azure configuration.
12. Pipeline the C# code to setup the four key webjobs.  Each should set to run continuously in singleton mode -- they are all designed to loop and sleep efficiently.
