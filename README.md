...
11. Use the files in /LegCRMtoGraph to populate a repo in your Azure Devops and configure appSettings.json in each of subdirectories to reflect your Azure configuration.
